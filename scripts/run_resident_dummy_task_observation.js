  ...
  return [
    {
      resident: "冬坂",
      name: "research-repro",
      title: "類似サービスのオンボーディング事例を調べる",
      description: "近いプロダクトの初回オンボーディング事例を調べ、どのような導線や説明が多いかを短く整理する。",
      expectedOutput: "事例調査メモ",
      reviewFocus: ["research", "market"],
    },
    {
      resident: "冬坂",
      name: "research-compare",
      title: "競合の機能説明を比較して利用者像を整理する",
      description: "競合や近い事例の説明文を見比べ、想定している利用者像と打ち出しの違いを比較表でまとめる。",
      expectedOutput: "比較表と利用者像メモ",
      reviewFocus: ["comparison", "audience"],
    },
    {
      resident: "久瀬",
      name: "program-fix",
