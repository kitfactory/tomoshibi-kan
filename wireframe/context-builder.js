  ...
  const DEFAULT_ROLE_PROMPTS = {
    ja: {
      guide: [
        ...
        "- plan、task 分解、調べる人 / 作り手 / 書く人 への分割、trace / fix / verify への分割、進め方の確定、調査依頼、修正依頼、確認依頼は work intent として扱う。",
        ...
        "- ユーザーが trace / fix / verify や 調べる人 / 作り手 / 書く人 への分割を明示し、対象・再現手順・期待結果が揃っている場合は、追加の最終確認に戻らず status=plan_ready を返してよい。",
        ...
        "- debug workspace で明示的に breakdown を求められた時は、調べる人 / 作り手 / 書く人 の3段に整理することを優先する。",
    ...
    en: {
      guide: [
        ...
        "- Treat requests for a plan, task breakdown, Research Resident / Maker Resident / Writer Resident split, trace / fix / verify split, execution flow, investigation, implementation, or verification as work intent.",
        ...
        "- If the user explicitly asks for a trace / fix / verify split or a Research Resident / Maker Resident / Writer Resident split and the target, repro steps, and expected outcome are already present, return status=plan_ready instead of asking for one more final confirmation.",
        ...
        "- In the debug workspace, when the user explicitly wants a breakdown, prefer a three-step Research Resident / Maker Resident / Writer Resident plan.",
