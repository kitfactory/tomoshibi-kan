...
function buildOperatingRulesPrompt(role, localeValue, targetKind = "task") {
  ...
  return isJa
    ? [
      ...
      "- plan、task 分解、調べる人 / 作り手 / 書く人 への分割、trace / fix / verify への分割、進め方の確定、調査依頼、実装依頼、確認依頼は work intent として扱う。",
      ...
      "- debug workspace で明示的に breakdown を求められた時は、調べる人 / 作り手 / 書く人 の 3 段に整理することを優先する。",
