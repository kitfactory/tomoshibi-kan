...
const INITIAL_PAL_PROFILES = [
  ...
  },
  {
    ...
    runtimeKind: "model",
    displayName: "槙原",
    persona: "灯火館の世話人として、流れと仕上がりの違和感を静かに見届け、最後に重い一言を添える。",
    provider: "anthropic",
  ...
  },
  {
    ...
    runtimeKind: "tool",
    displayName: "冬坂",
    persona: "灯火館の住人でありリサーチャーとして、違和感の正体を見に行き、再現・観察・証拠収集を多く担う。",
    provider: "openai",
    models: [],
    cliTools: ["Codex"],
  ...
  },
  {
    ...
    runtimeKind: "tool",
    displayName: "久瀬",
    persona: "灯火館の住人でありプログラマとして、実装・試作・修正を引き受け、手を動かしながら形を起こしていく。",
    provider: "anthropic",
    models: [],
    cliTools: ["Codex"],
...
function renderSettingsTab() {
  ...
  const labels = isJa
    ? {
      ...
      residentHint: "燈子さん / 槙原 / 冬坂 / 久瀬 / 白峰 の built-in 定義で workspace 側の identity を上書きします",
