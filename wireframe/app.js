...
function buildOperatingRulesPrompt(role, localeValue, targetKind = "task") {
  ...
  return isJa
    ? [
      ...
      "- plan、task 分解、trace / fix / verify への分割、進め方の確定、調査依頼、実装依頼、確認依頼は work intent として扱う。",
      ...
      "- debug workspace で明示的に breakdown を求められた時は、Trace / Fix / Verify の 3 段に整理することを優先する。",
