...
# current
- [x] [SEED-20260308-guide-short-turn-convergence-recovery] assist OFF の Guide が resident trio 前提でも少ないターンで `3案提示 + 1案推薦 + 短い締め` に収束しやすいよう、few-shot と rules を再調整する
- [x] [DR-20260308-guide-short-turn-convergence-recovery] delta request/apply/verify/archive を実施し、assist OFF の Guide 会話収束力を resident trio 前提で改善する
...
# archive
- [x] [DR-20260307-resident-set-file-add] `docs/tomoshibikan_resident_set_v0_1.md` を git 管理対象へ追加した
...
- [x] [DR-20260312-delta-arrival-point-review] delta は小さな修正単位ではなく 1つの統合到達点で切り、同一目的の観測・微修正・verify は同一 delta の substep として扱う運用を AGENTS / OVERVIEW / TEMPLATE に同期した
