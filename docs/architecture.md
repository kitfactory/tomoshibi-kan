...
- debug-purpose workspace では、`GuideConversationUseCase` は simple-role worker (`Trace Worker / Fix Worker / Verify Worker`) を優先候補として扱い、trace / fix / verify に分けやすい plan を出す。
